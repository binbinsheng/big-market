...
import com.binbinsheng.domain.credit.model.entity.CreditAccountEntity;
import com.binbinsheng.domain.credit.model.entity.CreditOrderEntity;
import com.binbinsheng.domain.credit.repository.ICreditRepository;
import com.binbinsheng.infrastructure.persistent.dao.IUserCreditAccountDao;
import com.binbinsheng.infrastructure.persistent.dao.IUserCreditOrderDao;
...
public class CreditRepository implements ICreditRepository {
    ...
    public void saveUserCreditTradeOrder(TradeAggregate tradeAggregate) {
        ...
        RLock lock = redisService.getLock(Constants.RedisKey.USER_CREDIT_ACCOUNT_LOCK +
                userId + Constants.UNDERLINE + creditOrderEntity.getOutBusinessNo());
